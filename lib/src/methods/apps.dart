...
class Apps {
  ...
  ///
  /// Params: none
  Future<Params> deleteAppRequests([Map<String, dynamic>? params]) async {
  ...
  Future<Params> getFriendsList([Map<String, dynamic>? params]) async {
  ...
  Future<Params> getLeaderboard([Map<String, dynamic>? params]) async {
  ...
  Future<Params> getScopes([Map<String, dynamic>? params]) async {
  ...
  ///
  /// `user_id` *(integer)*
  Future<Params> getScore([Map<String, dynamic>? params]) async {
  ...
  ///
  /// `separate` *(boolean)*
  Future<Params> sendRequest([Map<String, dynamic>? params]) async {
